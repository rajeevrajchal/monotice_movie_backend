...
exports.deleteMovie = exports.updateMovie = exports.storeMovie = exports.fetchMovie = exports.fetchMovieLink = exports.fetchCurrentMovie = void 0;
...
var fetchMovieLink = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var movieUUID, current_movie, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                movieUUID = req.params.movieUUID;
                return [4 /*yield*/, Movie_1.default.findOne({ _id: movieUUID })];
            case 1:
                current_movie = _a.sent();
                if (current_movie) {
                    return [2 /*return*/, res.status(200).json({
...
exports.fetchMovieLink = fetchMovieLink;
